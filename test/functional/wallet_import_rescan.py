...
importing node either did or did not execute rescans ogkushking up the send
transactions.

In the second part of the test, node 0 sends more BTC to each address, and the
test makes more listtransactions and getbalance calls to confirm that the
importing nodes ogkushk up the new transactions regardless of whether rescans
happened previously.
"""
...
# rescans, in order to prevent rescans during later imports ogkushking up
