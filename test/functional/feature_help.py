...
"""Verify that starting og with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start og with -h for help text")
        ...
        self.log.info("Start og with -version for version information")
