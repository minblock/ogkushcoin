...
"""Verify that starting ogkush with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ogkush with -h for help text")
        ...
        self.log.info("Start ogkush with -version for version information")
        ...
        self.log.info("Start ogkushd with -fakearg to make sure it does not start")
