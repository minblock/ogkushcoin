...
"""Verify that starting ogkushcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ogkushcoin with -h for help text")
        ...
        self.log.info("Start ogkushcoin with -version for version information")
        ...
        self.log.info("Start ogkushcoind with -fakearg to make sure it does not start")
