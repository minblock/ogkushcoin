# Support for Output Descriptors in OGKushcoin Core

Since OGKushcoin Core v0.17, there is support for Output Descriptors. This is a
...
existing OGKushcoin Core wallets, a convenience function `combo` is
