...
Note
---------------------
Always use absolute paths to configure and compile OGkush Core and the dependencies,
for example, when specifying the path of the dependency:

	../dist/configure --enable-cxx --disable-shared --with-ogkush --prefix=$BDB_PREFIX
...
Security
--------
To help make your OGkush Core installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, OGkush Core should be built with a non-executable stack,
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, OGkush Core may be compiled in
