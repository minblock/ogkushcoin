...
Output from `gbuild` will look something like
    ...
    From https://github.com/minblock/ogkush
...
[minblock/gitian.sigs.ltc](https://github.com/minblock/gitian.sigs.ltc/) repository, or if that's not possible create a pull
