...
*Setup instructions for a Gitian build of OG Core using a Debian VM or physical system.*

Gitian is the deterministic build process that is used to build the OG
