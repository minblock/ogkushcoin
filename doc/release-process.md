...
space *do not upload these to the og.bitwall.ca server, nor put them in the torrent*.
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the og.bitwall.ca server.

```

- Update og.bitwall.ca version
