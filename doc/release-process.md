...
### OGKush maintainers/release engineers, update version in sources
...
### Build and sign OGKush Core for Linux, Windows, and OS X:
    ...
    pushd ./gitian-builder
    ./bin/gbuild --memory 3000 --commit ogkush=v${VERSION} ../ogkush/contrib/gitian-descriptors/gitian-linux.yml
    ...
    ./bin/gbuild --memory 3000 --commit ogkush=v${VERSION} ../ogkush/contrib/gitian-descriptors/gitian-win.yml
    ...
    ./bin/gbuild --memory 3000 --commit ogkush=v${VERSION} ../ogkush/contrib/gitian-descriptors/gitian-osx.yml
