...
* Update manpages, see [gen-manpages.sh](https://github.com/og-project/og/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/og-project/og.git
...
- Detached signatures will then be committed to the [og-detached-sigs](https://github.com/og-project/og-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/og-project/og/releases/new) with a link to the archived release notes.
