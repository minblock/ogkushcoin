OG Core version 0.13.2 is now available from:
  ...
  <https://download.og.org/og-0.13.2.1/>
...
- **Signature covers value:** A simple improvement in the way signatures are
  ...
  of ogs they think they are spending, and by having full nodes refuse to
  accept those signatures unless the amount of ogs being spent is exactly
