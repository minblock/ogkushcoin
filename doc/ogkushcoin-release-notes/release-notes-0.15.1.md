OGKushcoin Core version *0.15.1* is now available from:

  <https://download.ogkushcoin.org/ogkushcoin-0.15.1/>
...
A number of changes to the way OGKushcoin Core deals with peer connections and invalid blocks
