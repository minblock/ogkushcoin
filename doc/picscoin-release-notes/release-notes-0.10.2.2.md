OGkush Core version 0.10.2.2 is now available from:

  <https://download.ogkushs.org/ogkush-0.10.2.2/>
...
- Testnet TCP port 22336 (instead of 18333)
- Testnet RPC TCP port 22336 (instead of 18332)
