...
* ogkush.conf: contains configuration settings for ogkushd or ogkush-qt
* ogkushd.pid: stores the process id of ogkushd while running
...
* debug.log: contains debug information and general logging generated by ogkushd or ogkush-qt
