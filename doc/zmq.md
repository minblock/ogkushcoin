...
during the *configure* step of building ogkushd:
...
These options can also be provided in ogkush.conf.
...
From the perspective of ogkushd, the ZeroMQ socket is write-only; PUB
sockets don't even have a read function. Thus, there is no state
introduced into ogkushd directly. Furthermore, no information is
