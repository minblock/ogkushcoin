Contributing to OGKushcoin Core
============================

The OGKushcoin Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the OGKushcoin Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/ogkushcoin-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to ogkushcoin-qt
...
The following applies to code changes to the OGKushcoin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall OGKushcoin
Network Protocol consensus changes.

Whether a pull request is merged into OGKushcoin Core rests with the project merge
...
Patches that change OGKushcoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the OGKushcoin consensus, it must have been
...
The project leader is the release manager for each OGKushcoin Core release.
