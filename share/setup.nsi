...
!define COMPANY "OG Core project"
...
VIAddVersionKey ProductName "OG Core"
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\OG Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\OG.lnk"
