...
{
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occurred. OGkush can no longer continue safely and will quit.") + QString("\n\n") + message);
    ::exit(EXIT_FAILURE);
}
...
int main(int argc, char *argv[])
{
    ...
    // Do not refer to data directory yet, this can be overridden by Intro::ogkushkDataDirectory
    ...
    // User language is set up: ogkushk a data directory
    if (!Intro::ogkushkDataDirectory(*node))
        return EXIT_SUCCESS;
