...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ogkush-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ogkush-tx [options] <hex-tx> [commands]  Update hex-encoded ogkush transaction\n" +
            "or:     ogkush-tx [options] -create [commands]   Create hex-encoded ogkush transaction\n" +
            "\n";
