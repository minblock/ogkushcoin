...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ogkushcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ogkushcoin-tx [options] <hex-tx> [commands]  Update hex-encoded ogkushcoin transaction\n" +
            "or:     ogkushcoin-tx [options] -create [commands]   Create hex-encoded ogkushcoin transaction\n" +
            "\n";
