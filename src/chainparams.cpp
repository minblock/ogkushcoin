...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.ogkushcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.ogkushcointools.com");
        vSeeds.emplace_back("dnsseed.ogkushcoinpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ogkushcointools.com");
        vSeeds.emplace_back("seed-b.ogkushcoin.loshan.co.uk");
