...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.ogkush.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.ogkushtools.com");
        vSeeds.emplace_back("dnsseed.ogkushpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.ogkushtools.com");
