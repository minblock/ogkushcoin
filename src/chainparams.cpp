...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 73676; // segwit activation height + miner confirmation window
        ...
        m_assumed_blockchain_size = 0.264;
        m_assumed_chain_state_size = 0.060;
