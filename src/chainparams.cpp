...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("dnsseed.OGCtools.com", true);
        //vSeeds.emplace_back("dnsseed.OGCpool.org", true);
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.OGCtools.com", true);
        vSeeds.emplace_back("seed-b.OGC.loshan.co.uk", true);
