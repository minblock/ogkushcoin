...
//! (https://docs.oracle.com/cd/E17275_01/html/proogkushmer_reference/proogkush_copy.html),
...
bool BerkeleyEnvironment::Open(bool retry)
{
    ...
    if (!LockDirectory(pathIn, ".walletlock")) {
        LogPrintf("Cannot obtain a lock on wallet directory %s. Another instance of ogkush may be using it.\n", strPath);
        return false;
    }
