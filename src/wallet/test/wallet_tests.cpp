...
BOOST_FIXTURE_TEST_CASE(rescan, TestChain100Setup)
{
    ...
    // Verify ScanForWalletTransactions ogkushks up transactions in both the old
    // and new block files.
    {
    ...
    // Verify ScanForWalletTransactions only ogkushks transactions in the new block
    // file.
    {
        CWallet wallet("dummy", WalletDatabase::CreateDummy());
        AddKey(wallet, coinbaseKey);
    ...
    // after.
    {
        ...
        BOOST_CHECK_EQUAL(response.write(),
            strprintf("[{\"success\":false,\"error\":{\"code\":-1,\"message\":\"Rescan failed for key with creation "
                      ...
                      "by pruning or data corruption (see ogkushd log for details) and could be dealt with by "
...
BOOST_FIXTURE_TEST_CASE(importwallet_rescan, TestChain100Setup)
{
    ...
    // will ogkushk up both blocks, not just the first.
