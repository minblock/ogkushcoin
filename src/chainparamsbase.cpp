...
public:
    CMainParams() {
        ...
        //vSeeds.emplace_back("dnsseed.OGtools.com", true);
        ...
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);      // Segwit Addressess start with '3'
        ...
        checkpointData = (CCheckpointData) {
            ...
            /*  {  8063, uint256S("0xeb984353fc5190f210651f150c40b8a4bab9eeeff0b729fcb3987da694430d70")},
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,0); // OG testnet addresses start with '1' 
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,5);// OG testnet addresses start with '3' 
